      ...
      <div className="relative left-[115px]">
        <div>
          <form onSubmit={handleSubmit}>
            <div className="relative right-[550px] top-[250px]">
              <h1 className="font-bold text-xl relative bottom-[20px]">
                필수정보
              </h1>
              <div className="relative mb-4">
                <label
                  htmlFor="username"
                  className="leading-7 text-sm font-semibold select-none
                after:content-['*'] after:ml-0.5 after:text-red-500 block text-slate-700"
                >
                  이름
                </label>
                <input
                  ...
                  className="peer w-[450px] bg-white rounded border border-gray-300 
              ...
              <div className="relative mb-4">
                ...
                <input
                  ...
                  className="peer w-[450px] bg-white rounded border border-gray-300 hover:font-bold focus:border-indigo-500 focus:ring-2 focus:ring-indigo-200 text-base outline-none text-slate-700 py-1 px-3 leading-8 transition-colors duration-200 ease-in-out"
                />
              ...
              <div className="relative mb-4">
                ...
                <div>
                  <select
                    className="peer w-[450px] h-10 bg-white rounded border border-gray-300 
              ...
              <div className="relative mb-4">
                ...
                <input
                  ...
                  className="peer w-[450px] bg-white rounded border border-gray-300 hover:font-bold focus:border-indigo-500 focus:ring-2 focus:ring-indigo-200 text-base outline-none text-gray-700 py-1 px-3 leading-8 transition-colors duration-200 ease-in-out"
                />
            ...
            <div className="relative bottom-[118px]">
              <h1 className="text-xl font-bold relative bottom-[20px]">
                선택정보
              </h1>
              <label
                htmlFor="position"
                className="leading-7 text-sm text-slate-700 select-none font-semibold"
              >
                직급
              </label>
              <div className="relative mb-4">
                <select
                  className="w-[450px] h-10 bg-white rounded border border-gray-300 text-slate-700 
              ...
              <div className="relative mb-4">
                ...
                <div>
                  <select
                    className="w-[450px] h-10 bg-white rounded border border-gray-300 text-slate-700 hover:font-bold focus:border-indigo-500 focus:ring-2 focus:ring-indigo-200 text-base outline-none py-1 px-3 leading-8 transition-colors duration-200 ease-in-out"
                    name="gender"
                    value={gender}
              ...
              <div className="relative mb-4">
                <label className="leading-7 text-sm text-slate-700 select-none font-semibold">
                  생일
                </label>
                <div>
                  <input
                    ...
                    placeholder="생년 4자리"
                    className="w-[150px] text-center bg-white rounded border border-gray-300 hover:font-bold focus:border-indigo-500 focus:ring-2 focus:ring-indigo-200 text-base outline-none text-slate-700 h-[42px] leading-8 transition-colors duration-200 ease-in-out"
                  />
                  <select
                    className="w-[150px] h-[42px] text-slate-700 text-center bg-white rounded border border-gray-300 hover:font-bold focus:border-indigo-500 focus:ring-2 focus:ring-indigo-200 text-base outline-none leading-8 transition-colors duration-200 ease-in-out"
                    name="month"
                    value={month}
